...
- Session 2
  - Design and power with weighted logrank and MaxCombo (Yilong)
...
- Note that
  ...
  - Amin Shirazi wrote a function for one version of this as 2020 intern
...
$$
  ...
  & = P_0(\{Z_{k}< a_{k}(\gamma)\}\cap_{j=1}^{k-1}\{a_{j}(\gamma)\le Z_{j}< b_{j}(\alpha)\}
  \end{align}
$$
