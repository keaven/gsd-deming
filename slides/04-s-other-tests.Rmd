...
- Accrual distribution:
  ...
  - Poisson process with piecewise uniform enrollment using `gsDesign::nSurv()` @LachinFoulkes and `gsdmvn::gs_design_ahr()`
...
- [Two-sample t-test](https://rconnect.merck.com:3939/gsd-training/fixed.html#two-sample-t-test)
- [Logrank test](https://rconnect.merck.com:3939/gsd-training/fixed.html#logrank-test)

## Sample size calculation under non-proportional hazards

- <https://rconnect.merck.com:3939/gsd-training/fixed.html#non-proportional-hazards>

## Fixed design with weighted logrank test

- [Examples](https://rconnect.merck.com:3939/gsd-training/fixed.html#weighted-logrank-test)
- [Technical details](https://rconnect.merck.com:3939/gsd-training/fixed.html#technical-details) are skipped

## Fixed design with MaxCombo test

- [Examples](https://rconnect.merck.com:3939/gsd-training/fixed.html#maxcombo-test)
...
- [Examples with pre-defined boundary](https://rconnect.merck.com:3939/gsd-training/wlr.html#example-scenario)
- [Examples with calculated boundary](https://rconnect.merck.com:3939/gsd-training/wlr-boundary.html)
- [Technical details](https://rconnect.merck.com:3939/gsd-training/wlr.html#technical-details-1) are skipped

## Group sequential design with MaxCombo test

- [Examples with pre-defined boundary](https://rconnect.merck.com:3939/gsd-training/wlr.html#example-scenario)
- [Examples with calculated boundary](https://rconnect.merck.com:3939/gsd-training/maxcombo-boundary.html)
- [Technical details](https://rconnect.merck.com:3939/gsd-training/maxcombo.html#outline-of-technical-details) are skipped
