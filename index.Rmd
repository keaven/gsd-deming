...
csl: ims.csl
link-citations: yes
description: 'We consider group sequential design for time-to-event endpoints under
...
path <- file.path(tempdir(), "gsd-training/")
pkglite::unpack(input = "rpkgs/modestWLRT.txt", output = path, quiet = TRUE, install = TRUE, upgrade = "never")
pkglite::unpack(input = "rpkgs/gsDesign2.txt", output = path, quiet = TRUE, install = TRUE, upgrade = "never")
pkglite::unpack(input = "rpkgs/simtrial.txt", output = path, quiet = TRUE, install = TRUE, upgrade = "never")
pkglite::unpack(input = "rpkgs/gsdmvn.txt", output = path, quiet = TRUE, install = TRUE, upgrade = "never")
```
...
options(repos = c(
  "https://rspm.merck.com/open_risk/latest",
  "https://rspm.merck.com/bardsdev/latest"
))
