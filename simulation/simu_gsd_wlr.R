...
results <- list(
  s01  = sim_gsd_wlr(N = 383, rg = tibble(rho = 0  , gamma = 0) ),
  s02  = sim_gsd_wlr(N = 384, rg = tibble(rho = 0  , gamma = 0) ),
  s03  = sim_gsd_wlr(N = 385, rg = tibble(rho = 0  , gamma = 0) ),
  s04  = sim_gsd_wlr(N = 386, rg = tibble(rho = 0  , gamma = 0) ),
  s05  = sim_gsd_wlr(N = 316, rg = tibble(rho = 0  , gamma = 1) ),
  s06  = sim_gsd_wlr(N = 317, rg = tibble(rho = 0  , gamma = 1) ),
  s07  = sim_gsd_wlr(N = 313, rg = tibble(rho = 0  , gamma = 0.5) ),
  s08  = sim_gsd_wlr(N = 314, rg = tibble(rho = 0  , gamma = 0.5) ),
  s09  = sim_gsd_wlr(N = 316, rg = tibble(rho = 0.5, gamma = 0.5) ),
  s10  = sim_gsd_wlr(N = 317, rg = tibble(rho = 0.5, gamma = 0.5) )
)
...
# cd /SFS/scratch/zhanyilo/simu_gsd_wlr
# rm *
# cp ~/gsdmvn/simulation/*.R .
# module add R/4.0.2
# qsub -t 1:2000 ~/runr.sh simu_gsd_wlr.R

#-------------------------------
# Summarize simulation results
#-------------------------------

# path <- "/SFS/scratch/zhanyilo/simu_gsd_wlr1"
#
# res <- list()
# for(i in 1:10000){
