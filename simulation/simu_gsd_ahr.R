...
#
# x_ahr <- gsdmvn:::gs_design_ahr(enrollRates = enrollRates, failRates = failRates,
...
#
#
# save(x_ahr, file = "simulation/simu_gsd_ahr.Rdata")
...
load(file.path(path, "simulation/simu_gsd_ahr.Rdata") )
...
for(i in 1:1){
  ...
  wlr_fit <- sim_gsd_wlr(N = N, rg = tibble(rho = 0, gamma = 0),
...
# cd /SFS/scratch/zhanyilo/ahr
# rm *
# cp ~/gsdmvn/simulation/*.R .
# module add R/4.0.2
# qsub -t 1:2000 ~/runr.sh simu_gsd_ahr.R
...
#
# save(x_ahr, simu_res, file = "simulation/simu_gsd_ahr.Rdata")
