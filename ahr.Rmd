...
### Example 4 {#SecAhrEgPhNphOneSided}
...
We will discuss the other designs in the next few sections, including symmetric design in Section \@ref(SecAhrEgPhNphSymmetric), asymmetric design in Section \@ref(SecAhrEgPhNphAsymmetric) and design with interims at specified times in Section \@ref(SecAhrEgPhNphSpecStop).
...
### Example 5 {#SecAhrEgPhNphSymmetric}
...
Second, we calculate the the sample size and crossing probability under non-proportional hazard by `gsdmvn::gs_design_ahr()`.
And we find the sample size is $465$ with $308$ events (you will want to round up events and sample size). 
...
### Example 6 {#SecAhrEgPhNphAsymmetric}
...
### Example 7 {#SecAhrEgPhNphSpecStop}
