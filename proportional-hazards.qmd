# Proportional hazards {#sec-proportional-hazards}
...
We have saved designs that can be re-loaded into the app in the book website at <https://github.com/keaven/gsd-deming>;
...
## Lachin and Foulkes method {#sec-lachin-foulkes}
...
## Metastatic oncology example {#sec-median-survival}
...
## Cure model {#sec-poisson-mixture}
